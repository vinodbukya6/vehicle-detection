...
rtsp_stream_address = "rtsp://127.0.0.1:8554/live" # rtsp://192.168.1.145:8554/live
# rtsp://rr:rr12345@192.168.1.145:8554/live
...
ffmpeg_process = subprocess.Popen([
    ...
    '-f', 'rawvideo',
    '-pixel_format', 'bgr24',
    '-video_size', '640x480',  # Adjust this resolution as needed
    '-framerate', '30',        # Adjust this framerate as needed
...
def vehicledetctionsystem(rtsp_video_feed):
    ...
    if input_file:
        ...
        tmp_output_path = "./temp_outputs/"+ "video_dum1.avi"
        ...
        while True:
            ...
            if True:
                ...
                # Getting predictions
                y_hat = model.predict(frame, conf = 0.7, classes = class_IDS, device = 'cpu', verbose = False, buffer=True)
                temp_end = time.time()
