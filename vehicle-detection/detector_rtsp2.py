...
model = YOLO('yolov8n.pt') #yolov8n.pt, best.pt
...
def vehicledetctionsystem(rtsp_video_feed):
    ...
    if input_file:
        ...
        img_height = int(cap1.get(cv2.CAP_PROP_FRAME_HEIGHT))
        img_width = int(cap1.get(cv2.CAP_PROP_FRAME_WIDTH))
        fps = cap1.get(cv2.CAP_PROP_FPS)
        print(img_height, img_width, fps)
...
if __name__ == '__main__':
    ...
    # Example usage:
    rtsp_video_feed = "/home/vinod/Projects/VehicleDetection/videosClient/video1.mkv"# 'rtsp://admin:rr123456@192.168.1.88:554/Streaming/Channels/1'
