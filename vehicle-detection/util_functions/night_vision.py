...
# img, image_gamma='auto', min_gamma=0.6, max_gamma=1.0, min_normalized_intensity=0.25
def night_vision_core(img, image_gamma='auto', min_gamma=0.1, max_gamma=1.0, min_normalized_intensity=0.05):
    """
